...
it skips injecting them again. Re-running the plugin keeps the class index stable, does not
duplicate timer fields or bind methods, and does not double-instrument method bodies.
