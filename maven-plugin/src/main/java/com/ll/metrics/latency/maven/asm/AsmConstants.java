...
final class AsmConstants {
  static final String TIMER_DESCRIPTOR = "Lcom/ll/metrics/latency/core/Timer;";
  static final String TIMER_INTERNAL_NAME = "com/ll/metrics/latency/core/Timer";
  static final String TIMERS_INTERNAL_NAME = "com/ll/metrics/latency/core/Timers";
